...
<div align="center" class="wrapper">
    ...
    <div id="formContent">
    <form:form action="editnext" modelAttribute="bus">
            <br>
            ID: ${bus.id} <form:hidden path="id"/><br><br>
            Bus Name: <form:input path="busName" name="busName" /><br>
            Bus Time: <form:input path="busTime" name="busTime" type="time"/><br>
            Bus Date: <form:input path="busDate" name="busDate" type="date"/><br>
            Bus Info: <form:input path="busInfo" name="accBal" /><br>
            Arrival place: <form:input path="arrival" name="arrival" /><br>
            Destination: <form:input path="destination" name="destination" /><br>
